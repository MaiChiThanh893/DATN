...
### 📟 Thiết bị (ESP32-C3)
- ❤️ Đo nhịp tim và SpO₂ qua cảm biến MAX30102 (giao tiếp I2C)
- 🌡️ Đo nhiệt độ và độ ẩm qua cảm biến HDC2022 (giao tiếp I2C)
- 🖥️ Hiển thị chỉ số trực tiếp trên màn hình OLED 128×64 (xoay vòng 4 chế độ hiển thị)
...
- **🗂️ Quản lý thiết bị / bệnh nhân:** Thêm, sửa, xóa thiết bị và gán tên bệnh nhân
...
|----------|----------------|----------------------|
| ❤️ Nhịp tim | 50–120 bpm     | < 50 hoặc > 120 bpm  |
| 💧 SpO₂     | ≥ 90%          | < 90%                |
| 🌡️ Nhiệt độ | ≤ 38.5°C       | > 38.5°C             |
...
|-----------------|----------------------------------------------------|
| 🎛️ Vi điều khiển   | ESP32-C3 (Arduino IDE, C++)                        |
| 📡 Cảm biến        | MAX30102 (HR/SpO₂), HDC2022 (nhiệt độ/độ ẩm)      |
| 🖥️ Màn hình        | OLED SSD1306 128×64                                |
| 🔌 Giao tiếp       | WiFi (HTTP POST), I2C                              |
| ⚙️ Backend         | PHP 7.3+ (không framework), lưu trữ JSON          |
...
- 🗃️ Không có cơ sở dữ liệu — thiết kế đơn giản, phù hợp cho demo và học tập.
