...
function build_alerts(?float $heartRate, ?float $spo2, ?float $temperature): array
{
    $alerts = [];
...
function append_device_data(array &$store, string $deviceId, ?string $patientName, float $heartRate, float $spo2, float $temperature, ?string $timestamp = null): array
{
